...
#     with open("warehouse_small_weight_test3.weight","w") as f:
#         f.write("[")
...
# def gen_weights_warehouse_small_002():
#     weights=np.ones((33,57,5),dtype=np.int32)*2
...
#     with open("warehouse_small_weight_002.weight","w") as f:
#         f.write("[")
#         for row in range(140):
#             for col in range(500):
#                 for dir in range(5):
...
# def gen_weights_warehouse_small_003():
#     weights=np.ones((33,57,5),dtype=np.int32)*2
...
#     with open("warehouse_small_weight_003.weight","w") as f:
#         f.write("[")
#         for row in range(140):
#             for col in range(500):
#                 for dir in range(5):
...
# def gen_weights_warehouse_small_004():
#     weights=np.ones((33,57,5),dtype=np.int32)*2
...
#     with open("warehouse_small_weight_004.weight","w") as f:
#         f.write("[")
#         for row in range(140):
#             for col in range(500):
#                 for dir in range(5):
...
# def gen_weights_warehouse_small_005():
#     weights=np.ones((33,57,5),dtype=np.float32)
...
#         with open("warehouse_small_weight_value_{}.weight".format(large),"w") as f:
#             f.write("[")
#             for row in range(140):
#                 for col in range(500):
#                     for dir in range(5):
...
# def gen_weights_warehouse_small_007():
#     weights=np.ones((33,57,5),dtype=float)
...
#     with open("warehouse_small_weight_007.weight","w") as f:
#         f.write("[")
#         for row in range(140):
#             for col in range(500):
#                 for dir in range(5):
...
def gen_weights_warehouse_small_008():
    weights=np.ones((33,57,5),dtype=float)
    ...
    with open("warehouse_small_weight_001.weight","w") as f:
        f.write("[")
        for row in range(33):
            for col in range(57):
                for dir in range(5):
...
gen_weights_warehouse_small_008()
